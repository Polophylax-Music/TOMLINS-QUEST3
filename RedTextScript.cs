...
public class RedTextScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (count == 0)
                this.targetText.text = "なんと！炎色の宝玉から精霊が出てきた。";
            if (count == 1)
                this.targetText.text = "炎の精霊：もし、我々との戦いに勝てたなら願いを聞いてやろう。";
            if (count == -6)
